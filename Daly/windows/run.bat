...
REM Usage: "%~dp0EPDataLogDalyWindows_v1-1.exe" -t [Interval Time(ms)] -c [COM Port Number]
...
REM Example: "%~dp0EPDataLogDalyWindows_v1-1.exe" -t 5000 -c 3
REM this will log one data every 5000 ms, communicating via COM3
REM ========================================


"%~dp0EPDataLogDalyWindows_v1-1.exe" -t 5000
pause