...
REM Usage: "%~dp0EPDataLogMewyeahWindows_v1-1.exe" -t [Interval Time(ms)] -c [COM Port Number]
...
REM Example: "%~dp0EPDataLogMewyeahWindows_v1-1.exe" -t 5000 -c 3
REM this is log one data every 5000 ms, communicating via COM3
REM ========================================

"%~dp0EPDataLogMewyeahWindows_v1-1.exe" -t 5000
pause